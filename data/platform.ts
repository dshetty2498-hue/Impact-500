...
export const researcherRecords: Researcher[] = [
  ...
  },
  {
    ...
    name: "Ayaan Motiwala",
    role: "Researcher",
    bio: "Ayaan Motiwala is a senior at Uplift North Hills Preparatory. He enjoys going to the gym, playing basketball, and has participated in numerous business competitions and internships throughout high school. He earned 1st Place at SMU ACAP, demonstrating his strong interest in business and leadership.",
    focus: "Energy and retail industries",
    contribution: "Ayaan researched and reviewed sources related to the Energy and Retail industries, helping identify relevant articles and organize supporting research used in developing company evaluations.",
    photoPosition: "center",
  ...
  },
  {
    ...
    role: "Researcher",
    bio: "Manvith Vippala is a senior at Uplift North Hills Preparatory. He enjoys going to the gym, investing, and helping operate a nonprofit organization that supports underserved communities in India.",
    focus: "Financial services and automotive industries",
    contribution: "Manvith researched and reviewed articles for the Financial Services and Automotive industries, helping gather supporting information used during company analysis.",
    photoPosition: "center",
  ...
  },
  {
    ...
    name: "Madhav Kumar",
    role: "Researcher",
    bio: "Madhav Kumar is a senior at Coppell High School. He enjoys working out and is both an offensive and defensive lineman on the Coppell High School football team. He is also involved with several nonprofit organizations.",
    focus: "Technology and consumer goods industries",
    contribution: "Madhav focused his research on the Technology and Consumer Goods industries, reviewing publicly available information that supported company evaluations.",
    photoPosition: "center",
  ...
  },
  {
    ...
    role: "Researcher",
    bio: "Ritvesh Achivenkata is an incoming senior at Coppell High School. He enjoys basketball, video games, and volunteering with multiple high schools in the community.",
    focus: "Healthcare and aerospace industries",
    contribution: "Ritvesh researched companies within the Healthcare and Aerospace industries, identifying relevant articles and background information used throughout the evaluation process.",
    photoPosition: "center",
  ...
  },
  {
    ...
    name: "Arya Bonthu",
    role: "Researcher",
    bio: "Arya Bonthu is an incoming senior at Coppell High School. He enjoys watching television shows and spending time with friends. He also helps lead an educational youth program at his local recreation center.",
  ...
  },
  {
    ...
    bio: "Sid Harish is an incoming junior at Coppell High School. He enjoys playing soccer and watching movies.",
    focus: "Visual design and user experience",
    contribution: "Sid assisted with the visual design and overall user experience of the Impact500 website, helping improve layout, usability, and interface consistency.",
    photoPosition: "center",
  },
];
