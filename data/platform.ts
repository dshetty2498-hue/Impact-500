...
export const researcherRecords: Researcher[] = [
  {
    ...
    focus: "Climate accountability and disclosure quality",
    contribution: "Designed the Impact500 evidence taxonomy and review protocol.",
    photoPosition: "16% center",
  },
  {
    slug: "jon-bell",
    name: "Jon Bell",
    ...
    focus: "Scoring systems and statistical validation",
    contribution: "Built the normalization model used across all four research pillars.",
  ...
  },
  {
    ...
    focus: "Supply chains, workforce outcomes, and governance",
    contribution: "Leads sector reviews and external-source verification.",
    photoPosition: "84% center",
  },
];
