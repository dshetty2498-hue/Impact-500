  ...
  return (
    <main>
      ...
      <div className="page-shell space-y-24">
        ...
        <section><SectionHeading eyebrow="Meet the Team" title="The students behind Impact500." text="Impact500 is the result of a collaborative effort by students with interests spanning business, technology, research, design, and community impact. Together, our team contributed thousands of hours researching corporate responsibility, organizing data, and helping build a platform dedicated to making CSR information more transparent and accessible." /><div className="mt-12"><TeamGrid /></div></section>
